...
<style>
  ...
  <form class="card-body" role="form" id="form-edit-sub-course" action="/app/sub-courses/update" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-sm-4 mb-3">
        <label class=" m-0 p-0 col-form-label" for="multicol-country">University Fee</label>
        <input type="tel" id="universityfee" name="universityfee" class="form-control" placeholder="University Fee" onkeypress="return isNumberKey(event)" value="<?php print $sub_course['University_fee'] == 0 ? '' : $sub_course['University_fee'] ?>" />
